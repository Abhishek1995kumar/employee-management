                    ...
                    @forelse ($permissions as $permission)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 action-select delete_permission" data-id="{{ $permission->id }}" data-name="{{ $permission->name }}">
                                    <span class="svg-icon svg-icon-3">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 mb-4 " id="updatePermissionNameDiv">
                                                    <div class="form-group">
                                                        <label class="required fs-6 fw-semibold mb-2">{{ __('Permission')}}</label>
