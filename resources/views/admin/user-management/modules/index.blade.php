        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                @foreach($permissions as $permission)
                    @if($permission->route_url == 'admin.modules.save')
                    ...
                    @forelse ($modules as $module)
                        <tr>
                            ...
                            <td class="text-center">
                                @foreach($permissions as $permission)
                                    @if($permission->route_url == 'admin.modules.update')
                                        <button type="button" 
                                    ...
                                    @if($permission->route_url == 'admin.modules.delete')
                                    ...
                                    @if($permission->route_url == 'admin.modules.show')
